<%-- 
    Document   : footerConfig
    Created on : Apr 13, 2019, 10:00:01 AM
    Author     : asus
--%>
        ...
        <div class="modal fade" id="configModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-auto">Select "Submit" below if you are sure about your changes!</div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancle</button>
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/ConfigServlet">Submit</a>
                    </div>
                </div>
            </div>
        </div>
